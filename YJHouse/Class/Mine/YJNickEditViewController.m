...
- (void)commitAction {
    if (self.nickTextField.text.length) {
        [SVProgressHUD show];
        [[NetworkTool sharedTool] requestWithURLString:@"https://ksir.tech/you/frontend/web/app/user/set-nickname" parameters:@{@"nickname":self.nickTextField.text,@"auth_key":[LJKHelper getAuth_key]} method:POST callBack:^(id responseObject) {
