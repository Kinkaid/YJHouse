...
- (void)loadMsgData {
    ...
    [[NetworkTool sharedTool] requestWithURLString:@"https://youjar.com/you/frontend/web/app/user/get-message-list" parameters:params method:POST callBack:^(id responseObject) {
