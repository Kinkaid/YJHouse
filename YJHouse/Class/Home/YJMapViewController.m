...
@interface YJMapViewController ()<MKMapViewDelegate,CLLocationManagerDelegate>
{
    MKMapView *_mapView;
...
- (void)viewDidLoad {
    ...
    _mapView =[[MKMapView alloc]initWithFrame:CGRectMake(0, 64, APP_SCREEN_WIDTH, APP_SCREEN_HEIGHT - 64)];
